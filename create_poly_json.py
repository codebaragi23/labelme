...
parser.add_argument('--input', type=str, default="images_test/road1_watershed_mask.png", help='image mask input to compute all polygons')
...
out = open('images_test/road1.json','w')
data = {}
data["version"] = "3.6.16"
data["flags"] = {}
data["annotations"] = []
