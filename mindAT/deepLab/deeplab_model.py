...
def deeplab_v3_plus_generator(num_classes,
	...
	def model(inputs, is_training):
		...
		if is_training:
			...
			exclude = [base_architecture + '/logits', 'global_step', base_architecture + '/conv1/weights']
...
def deeplabv3_plus_model_fn(features, labels, mode, params):
	...
	if 'row' in params :
		predictions = {
			...
			'row': params['row'],
			'col': params['col'],
			'row_off': params['row_offs'],
			'col_off': params['col_offs'],
	...
	#                                [labels, params['batch_size'], params['num_classes'], params['num_channels']], tf.uint8)
