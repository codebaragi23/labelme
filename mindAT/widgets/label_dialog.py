...
class LabelDialog(QtWidgets.QDialog):
    def __init__(
        ...
        self.edit.setValidator(mindAT.utils.labelValidator())
        ...
        bb.button(bb.Ok).setIcon(mindAT.utils.newIcon("done"))
        bb.button(bb.Cancel).setIcon(mindAT.utils.newIcon("undo"))
